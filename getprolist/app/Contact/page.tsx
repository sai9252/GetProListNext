    ...
    <div className="md:px-20 md:py-10 sm:px-10 sm:py-5 px-2 py-2">
      ...
      <div className="bg-gray-100 rounded-3xl mt-10 md:px-20 md:py-12 px-10 py-5 md:m-3 m-2">
        <div className="flex flex-col justify-between items-center gap-4">
          ...
          <Button className="text-gray-300 h-11 w-48">
      ...
      <div className="border border-gray-300 rounded-xl mt-3">
        <div className="md:flex md:justify-between ">
          <div className="flex lg:p-8 p-4 items-center">
            <ul className="flex flex-col items-start border-b-gray-300 ">
              <Button variant="link" className="h-6 text-[16px]">
                About Us
              </Button>
              <Button variant="link" className="h-6 text-[16px]">
                Terms & Conditions
          ...
          <div className="md:flex md:items-center md:justify-center md:flex-col md:p-8 lexend hidden">
            <Image
              src="/logo.png"
              alt="GetProList Logo"
              width={120}
      ...
      <div className=" border rounded-lg border-t-gray-300 flex justify-center items-center p-3">
